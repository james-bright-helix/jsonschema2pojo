...
public class RuleFactory {
     ...
     * @param bindingStore
     *            the object used by this factory to get bindings
     */
    public RuleFactory(GenerationConfig generationConfig, Annotator annotator, SchemaStore schemaStore, BindingStore bindingStore) {
    ...
    /**
     * Create a new rule factory with the given generation config options. Uses a default {@link BindingStore}.
     *
     * @param generationConfig
     *            The generation config options for type generation. These
     *            config options will influence the java code generated by rules
    ...
    public RuleFactory(GenerationConfig generationConfig, Annotator annotator, SchemaStore schemaStore) {
       this(generationConfig, annotator, schemaStore, new BindingStore());
    }
     ...
     */
    public RuleFactory() {
        this(new DefaultGenerationConfig(), new Jackson2Annotator(), new SchemaStore(), new BindingStore());
    }
    ...
    /**
     * Provides a rule instance that should be applied to a node to override its
     * Java type based on the binding definitions. 
     * 
     * @return a binding rule that can override the Java type for a
     *         given schema node.
     */
    public Rule<JClassContainer, JType> getBindingRule() {
        return new BindingRule(this);
    }

    /**
     * Get the {@link BindingStore} used by binding rules.
     * 
     * @return the currently configured {@link BindingStore}.
     */
    public BindingStore getBindingStore() {
        return bindingStore;
    }


    /**
     * Set the {@link BindingStore} used by binding rules.
     * 
     * @param bindingStore the {@link BindingStore} to use.
     */
    public void setBindingStore(BindingStore bindingStore) {
        this.bindingStore = bindingStore;
    }
}
